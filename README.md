...
Созданы каркас репозитория, исследовательские read-only инструменты, engine-neutral модель собственного сценария v1, детерминированная JSON persistence и headless-основа редактора. Игровые механики, графический редактор, импорт исходных форматов и интеграция Godot ещё не реализованы.
